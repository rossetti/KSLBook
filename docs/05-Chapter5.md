...
::: {.infobox .note data-latex="{note}"}
**NOTE!**
The KSL also supports the construction and simulation of experimental designs. This functionality is described in Section \@ref(ch10doe) of Chapter \@ref(ch10eo).
:::
